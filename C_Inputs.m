...
% FCC Case:
 twin{tnum}.CS=opt.CS{2};
 twin{tnum}.name='Sigma3 <112>(111)';
 twin{tnum}.k1=Miller(1,1,1,twin{tnum}.CS,'hkl'); %What you specify here affects sign and schmid value
 twin{tnum}.eta1=Miller(-1,2,-1,twin{tnum}.CS,'uvw'); %What you specify here affects sign and schmid value
 twin{tnum}.actType=1; %i.e. 180 around K1, 180 around eta, compound K1 then eta1, compound eta1 then K1
